      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 max-w-full">
        <div className="p-3 rounded-lg shadow-sm relative">
          <div className="mb-2 ml-4">
            <img src={company1} alt="Company Logo" className="w-20 h-20 object-cover rounded-full mx-auto" />
          </div>
          <div className="text-center ml-4">
            <h2 className="text-lg font-semibold mb-1">Software Developer</h2>
        ...
        <div className="p-3 rounded-lg shadow-sm relative">
          ...
          <div className="mb-2 ml-4">
            <img src={company2} alt="Company Logo" className="w-20 h-20 object-cover rounded-full mx-auto" />
          </div>
          <div className="text-center ml-4">
            <h2 className="text-lg font-semibold mb-1">Junior Web Developer</h2>
        ...
        <div className="p-3 rounded-lg shadow-sm relative">
          <div className="absolute left-0 top-0 bottom-0 w-1 bg-white shadow-sm"></div>
          <div className="mb-2 ml-4">
            <img src={company3} alt="Company Logo" className="w-20 h-20 object-cover rounded-full mx-auto" />
          </div>
          <div className="text-center ml-4">
            <h2 className="text-lg font-semibold mb-1">Frontend Intern</h2>
        ...
        <div className="p-3 rounded-lg shadow-sm relative">
          <div className="absolute left-0 top-0 bottom-0 w-1 bg-white shadow-sm"></div>
          <div className="mb-2 ml-4">
            <img src={company4} alt="Company Logo" className="w-20 h-20 object-cover rounded-full mx-auto" />
          </div>
          <div className="text-center ml-4">
            <h2 className="text-lg font-semibold mb-1">IT Support Assistant</h2>
